/*
 * Occupancy Optimization Level 1: Occupancy Basics - Function 1
 *
 * This file demonstrates occupancy querying and optimization techniques.
 */
...
void findOptimalBlockSize() {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        // Query occupancy for each block size
        int numBlocks = 0;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&numBlocks,
...
void sharedMemoryOccupancyTest() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        // Query occupancy with shared memory
        int numBlocks = 0;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&numBlocks,
...
int main() {
    printf("=== Occupancy Optimization Level 1: Occupancy Basics ===\n\n");
