# Install script for directory: /home/ammar/work/cutlass_learninig/third_party/cutlass/examples/47_ampere_gemm_universal_streamk
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/ammar/work/cutlass_learninig/build/cutlass-build/examples/47_ampere_gemm_universal_streamk/47_ampere_gemm_universal_streamk")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/47_ampere_gemm_universal_streamk" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/47_ampere_gemm_universal_streamk")
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/ammar/work/cutlass_learninig/build/cutlass-build/examples/47_ampere_gemm_universal_streamk/47_ampere_gemm_universal_streamk_broadcast")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/47_ampere_gemm_universal_streamk_broadcast" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/47_ampere_gemm_universal_streamk_broadcast")
    if(CMAKE_INSTALL_DO_STRIP)
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/test/cutlass/ctest/ctest_examples_47_ampere_gemm_universal_streamk_broadcast" TYPE FILE RENAME "CTestTestfile.ctest_examples_47_ampere_gemm_universal_streamk_broadcast.cmake" FILES "/home/ammar/work/cutlass_learninig/build/cutlass-build/examples/47_ampere_gemm_universal_streamk/ctest/ctest_examples_47_ampere_gemm_universal_streamk_broadcast/CTestTestfile.ctest_examples_47_ampere_gemm_universal_streamk_broadcast.install.cmake")
endif()

string(REPLACE ";" "\n" CMAKE_INSTALL_MANIFEST_CONTENT
       "${CMAKE_INSTALL_MANIFEST_FILES}")
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/ammar/work/cutlass_learninig/build/cutlass-build/examples/47_ampere_gemm_universal_streamk/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
