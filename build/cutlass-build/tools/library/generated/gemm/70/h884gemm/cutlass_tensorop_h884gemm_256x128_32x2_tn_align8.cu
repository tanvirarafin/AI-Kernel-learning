...
// Gemm operator cutlass_tensorop_h884gemm_256x128_32x2_tn_align8
using cutlass_tensorop_h884gemm_256x128_32x2_tn_align8_base =
...
// Define named type
struct cutlass_tensorop_h884gemm_256x128_32x2_tn_align8 :
  public cutlass_tensorop_h884gemm_256x128_32x2_tn_align8_base { };
...
void initialize_cutlass_tensorop_h884gemm_256x128_32x2_tn_align8(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_h884gemm_256x128_32x2_tn_align8>
    >("cutlass_tensorop_h884gemm_256x128_32x2_tn_align8"));
