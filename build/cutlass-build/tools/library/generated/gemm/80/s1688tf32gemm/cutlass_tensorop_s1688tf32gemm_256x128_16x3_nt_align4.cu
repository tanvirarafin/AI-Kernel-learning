...
using cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4_base =
...
struct cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4 :
  public cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4_base { };
...
void initialize_cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4>
    >("cutlass_tensorop_s1688tf32gemm_256x128_16x3_nt_align4"));
