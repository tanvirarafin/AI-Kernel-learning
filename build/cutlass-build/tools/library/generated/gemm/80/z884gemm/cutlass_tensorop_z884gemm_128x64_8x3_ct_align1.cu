...
// Gemm operator cutlass_tensorop_z884gemm_128x64_8x3_ct_align1
using cutlass_tensorop_z884gemm_128x64_8x3_ct_align1_base =
...
// Define named type
struct cutlass_tensorop_z884gemm_128x64_8x3_ct_align1 :
  public cutlass_tensorop_z884gemm_128x64_8x3_ct_align1_base { };
...
void initialize_cutlass_tensorop_z884gemm_128x64_8x3_ct_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_z884gemm_128x64_8x3_ct_align1>
    >("cutlass_tensorop_z884gemm_128x64_8x3_ct_align1"));
