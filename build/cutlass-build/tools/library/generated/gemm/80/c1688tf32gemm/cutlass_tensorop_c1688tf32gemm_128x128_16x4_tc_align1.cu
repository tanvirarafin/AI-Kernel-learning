...
// Gemm operator cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1
using cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1_base =
...
// Define named type
struct cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1 :
  public cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1_base { };
...
void initialize_cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1>
    >("cutlass_tensorop_c1688tf32gemm_128x128_16x4_tc_align1"));
