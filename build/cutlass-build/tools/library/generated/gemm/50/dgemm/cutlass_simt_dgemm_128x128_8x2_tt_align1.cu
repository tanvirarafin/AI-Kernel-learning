...
// Gemm operator cutlass_simt_dgemm_128x128_8x2_tt_align1
using cutlass_simt_dgemm_128x128_8x2_tt_align1_base =
...
// Define named type
struct cutlass_simt_dgemm_128x128_8x2_tt_align1 :
  public cutlass_simt_dgemm_128x128_8x2_tt_align1_base { };
...
void initialize_cutlass_simt_dgemm_128x128_8x2_tt_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_simt_dgemm_128x128_8x2_tt_align1>
    >("cutlass_simt_dgemm_128x128_8x2_tt_align1"));
